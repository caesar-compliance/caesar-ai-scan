...
- `schemas/supabase-migration-rehearsal.schema.json` (T020 migration rehearsal contract)
- `docs/backend/supabase/rehearsal/` (T020 forward/rollback rehearsal SQL and manifest)
- `src/supabase-rehearsal/supabase-migration-rehearsal-report.mjs` (T020 rehearsal Markdown report builder)
- `scripts/validate-supabase-migration-rehearsal.mjs` (T020 SQL safety validator)
- `scripts/build-supabase-migration-rehearsal-report.mjs` (T020 rehearsal report generator)
